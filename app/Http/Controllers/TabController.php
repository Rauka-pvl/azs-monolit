...
class TabController extends Controller
{
    ...
    public function loginTab(Request $request)
    {
        ...
        $user = User::select('users.id as user_id', 'users.name', 'users.photo', 'azs.id as azs_id', 'azs.adress', 'azs.name as azs_name')->
    ...
    {
        $user = User::select('users.id as user_id', 'users.name', 'users.photo', 'azs.id as azs_id', 'azs.adress', 'azs.name as azs_name', 'azs.zone')->
            join('azs_to_user', 'azs_to_user.user_id', '=', 'users.id')->
            join('azs', 'azs.id', '=', 'azs_to_user.azs_id')->
            find($user_id);
