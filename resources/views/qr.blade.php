            ...
            <main>
                <nav class="navbar bg-body-tertiary">
                    <div class="container container-fluid">
                        <a class="navbar-brand" href="#">
                            <img src="{{ Storage::url('icons/water.png') }}" alt="Logo" width="30"
                ...
                <div class="container">
                    <div class="center-img">
                        <img src="{{ Storage::url('photo/' . $user->photo ?? 'pupil.png') }}" alt="User Photo"
                            width="100">
                        <h1>{{ $user->name }}</h1>
                        <h4>{{ $user->azs_name }}</h4>
                        <h4>{{ $user->adress }}</h4>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == true) {
                        ...
                        var checkmark = $('<img>').attr('src',
                                '{{ Storage::url('icons/chekmark.gif') }}')
                            .css({
                                'width': '100px',
                                'height': '100px'
                            });
                        ...
                        setTimeout(() => {
                            checkmark.attr('src',
                                '{{ Storage::url('icons/chekmark.png') }}');
                        }, 1000);
                    }
                },
